...
def cnfg():
    ...
    _initial_model = "/tmp/best-checkpoint/best-checkpoint.pth"
    ...
    _batch_size = 30  # 30; não definido na tese
    _epochs = 150
    _classifier = "linear"
...
def main(_folder, _csv_path_train, _imgs_folder_train, _lr_init, _sched_factor, _sched_min_lr, _sched_patience,
         ...
         _initial_model, _task, _task_dict, _classifier):
    ...
    model = set_model(_model_name, len(_labels_name), neurons_reducer_block=_neurons_reducer_block,
                      comb_method=_comb_method, comb_config=_comb_config, pretrained=_pretrained, classifier=_classifier)
